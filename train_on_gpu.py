...
os.environ['MIOPEN_USER_DB_PATH'] = cfg.miopen_user_db_path # for GPU
os.environ['MIOPEN_DISABLE_CACHE'] = cfg.mipoen_disable_cache # for GPU
...
def get_safe_exp_fn():
    return get_safe_experiment_fn("train_on_gpu.experiment_fn")
